    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-(--available-height) w-(--anchor-width) min-w-36 overflow-x-hidden overflow-y-auto border border-midground/15 bg-background-base shadow-lg",
            className
          )}
          {...props}
        >
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "top-0 z-10 flex w-full cursor-default items-center justify-center bg-background-base py-1 text-midground/50 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn(
        "bottom-0 z-10 flex w-full cursor-default items-center justify-center bg-background-base py-1 text-midground/50 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
